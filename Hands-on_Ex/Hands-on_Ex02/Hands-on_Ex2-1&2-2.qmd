---
title: "Hands-on Exercise 2-1 & 2-2"
...
plot(st_geometry(bk), main = "Bukit Batok")
```
...
childcare_bk_ppp = childcare_ppp[bk_owin]
```
...
childcare_bk_ppp.km = rescale.ppp(childcare_bk_ppp, 1000, "km")
```
...
plot(unmark(childcare_jw_ppp.km), 
  main="Jurong West")
plot(unmark(childcare_bk_ppp.km), 
  main="Bukit Batok")
```
...
```{r}
clarkevans.test(childcare_bk_ppp,
                correction="none",
                clipregion=NULL,
                alternative=c("two.sided"),
                nsim=999)
...
plot(density(childcare_jw_ppp.km, 
             ...
             kernel="gaussian"),
     main="Jurong West")
plot(density(childcare_bk_ppp.km, 
             sigma=bw.diggle, 
             edge=TRUE, 
             kernel="gaussian"),
     main="Bukit Batok")
